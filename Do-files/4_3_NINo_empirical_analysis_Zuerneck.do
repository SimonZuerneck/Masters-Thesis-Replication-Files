...
*===============================================================================
*Figure 3: LTIM -- Estimated Event Study Coefficients Using DiD
*==============================================================================3
...
foreach g of local group {
	...
	*Reference period (ommited due to multicollinearity) 
...
foreach t in 2018q1 2019q4 {
    ...
    foreach g of local group {
		...
		*start_date
		if "`g'" == "group_simon" {
			local start_date 2015q1 // 7 pre-treatment periods considered
		}
...
foreach g of local group {
	...
	*SDiD Regressions	
	...
	g2_opt( ///
		legend(order(2 "EU Inflow Estimates" 1 "Non-EU Inflow Estimates" ) ///
...
foreach g of local group {
	...
	*Put a vertical line at the time where the treatment occurs 
