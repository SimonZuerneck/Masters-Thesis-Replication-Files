...
*and World Bank classification from 2022 
*===============================================================================
...
*now generate a treatment group indicator 
...
*Generate one dummy for treatment and control group following Clifton
gen group_clifton = . 
...
*Create a dataset out of the subgroups and nationalities there
*copied into an Excel file (Subgroups_nationalities_NINo)
cd "$my_path_in/Countries
